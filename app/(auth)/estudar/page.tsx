...
export default function EstudarPage() {
  ...
  // Melhoria 3: progresso percentual para a barra
  ...
  return (
    <main className="container py-4">
      {/* Melhoria 3: cabeçalho com seletor de quantidade ao lado do botão Nova rodada */}
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
          <h1 className="h3 mb-0">Estudar</h1>
          <p className="text-muted mb-0 small">Questões selecionadas com base no seu perfil e histórico.</p>
        </div>
      ...
      {loading && !questaoAtual ? (
        ...
        <>
          {/* Melhoria 3: barra de progresso acima do card */}
          <div className="progress mb-3" style={{ height: '6px' }} role="progressbar" aria-valuenow={currentIndex} aria-valuemin={0} aria-valuemax={questoes.length}>
            <div
              className="progress-bar bg-primary"
              style={{ width: `${progresso}%`, transition: 'width 0.3s ease' }}
            />
          </div>
